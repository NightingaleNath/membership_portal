    ...
    <div class="pcoded-container navbar-wrapper">
        ...
        <div class="pcoded-main-container">
            <div class="pcoded-wrapper">
                 <?php $page_name = "membership_report"; ?>
                                    ...
                                    <div class="row align-items-end">
                                        <div class="col-lg-8">
                                            <div class="page-header-title">
                                                <div class="d-inline">
                                                    <h4><?php echo htmlspecialchars($translations['membership_report']); ?></h4>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                                        ...
                                                                        <div class="tab-pane active" id="clock_in" role="tabpanel">
                                                                            <div class="auth-box col-xl-12">
                                                                                ...
                                                                                <div class="row m-t-15">
                                                                                    <div class="col-md-12">
                                                                                        <button id="generate_report" type="submit" class="btn btn-primary btn-md btn-block waves-effect text-center"><?php echo htmlspecialchars($translations['generate_report']); ?></button>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                                ...
                                                                                <table id="simpletable" class="table  table-striped table-bordered nowrap">
                                                                                    <thead>
                                                                                        <tr>
                                                                                            ...
                                                                                            <th><?php echo htmlspecialchars($translations['expires_on']); ?></th>
                                                                                        </tr>
                                                                                    </thead>
                                                                                    <tbody id="report-table-body">
                                                                                        <!-- Filtered results will be inserted here member_report.php -->
                                                                                    </tbody>
                                                                                    <tfoot>
                                                                                        <tr>
                                                                                            <th><?php echo htmlspecialchars($translations['membership_number']); ?></th>
